...
<body>
    ...
    <div class="container" style="width:100%; margin-top:100pt;">
        ...
        <script>
            Swal.fire({
                title: "Administrador no eliminado",
        ...
        <script>
            Swal.fire({
                title: "Administrador no reactivado",
        ...
        @endif
        <div class="row">
            <p class="text-center" style="font-size:16pt; font-weight:bold; color:black">Gestión de Administradores</p>
            <p class="text-center" style="font-size:12pt; color:black">Listado de administradores activos e inactivos con opciones para ver información y eliminar o reactivar administrador</p>
            <div class="col-12">
                        ...
                        <ul class="nav nav-tabs card-header-tabs">
                            <ul class="nav nav-tabs card-header-tabs" id="myTab">
                                <li class="nav-item mb-2">
                                    <a href="#activos" class="nav-link active link-body-emphasis link-underline link-underline-opacity-0" data-bs-toggle="tab">Administradores Activos</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a href="#inactivos" class="nav-link link-body-emphasis link-underline link-underline-opacity-0" data-bs-toggle="tab">Administradores Inactivos</a>
                                </li>
                            </ul>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="activos">
                                ...
                                <table class="table table-bordered data-table" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($administradoresActivos as $administrador)
                                        <tr>
                                            <td>{{$administrador->carnet}}</td>
                                            <td>{{$administrador->apellidos.', '.$administrador->nombres}}</td>
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 mx-0 px-0">
                                                        <button type="button" class="btn btn-danger icon-button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Eliminar" onclick="eliminarAdministrador('{{$administrador->DUI}}')">
                            ...
                            <div class="tab-pane fade" id="inactivos">
                                ...
                                <table class="table table-bordered data-table" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($administradoresInactivos as $administrador)
                                        <tr>
                                            <td>{{$administrador->carnet}}</td>
                                            <td>{{$administrador->apellidos.', '.$administrador->nombres}}</td>
                                            <td>
    ...
    <div class="modal fade" id="eliminarAdministrador" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:5000">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('admin.deleteAdministrador')}}">
                    @csrf
                    @method('DELETE')
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4" hidden>
                                ...
                                <input type="text" class="form-control" name="id" id="id" placeholder="Número de identificación del administrador" value="{{ old('id') }}">
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="reactivarAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:5000">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Reactivar administrador</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="{{route('admin.restoreAdmin')}}">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4" hidden>
                                ...
                                <input type="text" class="form-control" name="idR" id="idR" placeholder="Número de identificación del administrador" value="{{ old('nie') }}">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
