                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-12 mb-2">
                                        <button type="button" class="btn btn-warning" onclick="actualizarFotoModal('{{$administrador[0]->DUI}}')" style="width:75%">Actualizar foto de perfil</button>
                                    </div>
                                    @endif
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modalFotoAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:5000">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('admin.updateAdminFoto')}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6 mb-4" hidden>
                                ...
                                <input type="text" class="form-control" name="id" id="id" placeholder="Número de identificación del administrador" value="{{ old('nie') }}">
                            </div>
