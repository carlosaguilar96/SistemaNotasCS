    ...
    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
                <h4 class="card-title mb-4" style="font-weight: bold">Cambiar contraseña de profesor</h4>
                @if ($errors->any())
                ...
                @endif
                <form method="POST" action="{{route('profesor.cambiarContraseñaProfesor')}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
