                ...
                <div class="card mb-3" style="max-width: 100%;">
                    <div class="row g-0">
                        <div class="col-md-4" style="align-items: center;display: flex;justify-content: center;">
                            <img src="{{asset('img/fotosA/'.$user[0]->foto)}}" style="height: 200px; width:200px" class="img-fluid rounded-start my-4" alt="Foto del administrador">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title"><b>{{$user[0]->nombres.' '.$user[0]->apellidos}}</b></h5>
                                <p class="card-text"><b>{{$user[0]->carnet}}</b></p>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        <p class="card-text text-start">
                                            <b>Correo:</b> {{$user[0]->correo}}
                                        </p>
                                    </div>
                                    @if($user[0]->estadoeliminacion==0)
